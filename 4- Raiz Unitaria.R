...
library(readxl)
interdaay <- read_excel(C:Econometria:3-EconometriaAvancada-Aula3-master,
...
plot(dados_diarios, col= "red", main="Dados do Indice Bovespa", xlab="Dias")   #Plota os três gráficos em azul e com as legendas
...
plot(Ibovespa, main="Indice do Dia",col="green")                            #Grafico da Ibovespa, com cores e legendas especificadas
plot(Quantidade, main="Indice do Dia", xlab="Dias", col="yellow")           #Grafico da Quantidade, com cores, legendas e eixo "x" especificados
